...
const LifestyleMedicineAssessment = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', fontFamily: '"Epilogue", system-ui, sans-serif', padding: '2rem 1rem', display: 'flex', flexDirection: 'column' }}>
      <style>{`
      ...
      <div style={{ width: '100%', margin: '0 auto', padding: '0 1rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ background: 'white', borderRadius: '24px', padding: 'clamp(1.5rem, 4vw, 3rem)', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', minHeight: '600px', flex: 1, margin: '0 auto', width: '100%' }}>
